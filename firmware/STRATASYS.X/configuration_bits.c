...
// FOSCSEL
#pragma config FNOSC = PRIPLL              // Initial oscillator Source Selection Bits (Primary oscillator w/PLL)
#pragma config IESO = OFF               // Two Speed Oscillator Start-Up Bit (Start up device with user selected oscillator source)

// FOSC
#pragma config POSCMD = HS              // Primary Oscillator Mode Select Bits (Primary Oscillator Crystal)
...
// FDMT
#pragma config DMTEN = DISABLE           // Dead Man Timer Disable Bit (Dead Man Timer is Enabled and cannot be enabled by software)
